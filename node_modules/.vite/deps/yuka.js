...
var Logger = class {
  ...
  */
  static log(...args) {
    if (currentLevel <= Logger.LEVEL.LOG)
      console.log(...args);
  }
  /**
...
var FuzzyCompositeTerm = class extends FuzzyTerm {
  /**
...
var CompositeGoal = class extends Goal {
  /**
  ...
  executeSubgoals() {
    ...
    for (let i = subgoals.length - 1; i >= 0; i--) {
      ...
      if (subgoal2.completed() === true || subgoal2.failed() === true) {
        if (subgoal2 instanceof CompositeGoal) {
